...
2. The options of likelihoods that this package supports is limited to Poisson, Laplace with known mean, normal with known mean, Rayleigh, Maxwell-Boltzmann, gamma with known shape, inverse gamma with known shape, L{'e}vy with known mean, Weibull with known rho=shape/scale, Burr XII with known c, Pareto with known scale, Dagum with known a and b, and Gompertz with known scale.
